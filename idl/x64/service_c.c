...
/* Standard interface: service, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO service_ProxyInfo;
    ...
    /* [in] */ unsigned long long envFlag)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&service_ProxyInfo,
                  0,
                  0,
                  IDL_handle,
                  pid,
...
static const MIDL_STUB_DESC service_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& service_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO service_ProxyInfo =
    {
    &service_StubDesc,
    service__MIDL_ProcFormatString.Format,
    service_FormatStringOffsetTable,
