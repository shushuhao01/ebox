...
public:
	...
	static constexpr int kVerMinor = 9;
	static constexpr int kVerPatch = 7;
	static constexpr int kVerCode  = 20907;  // 单调递增数字，用于版本比较

	static constexpr std::wstring_view appName{L"eBox"};
	static constexpr std::string_view appNameA{"eBox"};
	static constexpr std::wstring_view appVersion{L"v2.9.7"};
	static constexpr std::wstring_view appUpdateDate{L"2026/8/27"};
