...
namespace biz
{
	...
	// 			throw std::runtime_error{std::format("The current system file analysis has failed, eBox cannot run properly\nerror msg: {}", errorMsg)};
	// 		});
	// 	}
	// 	catch (...)
	// 	{
	...
	// 		{
	// 			// ReSharper disable once StringLiteralTypo
	// 			throw std::runtime_error("The current system file analysis has failed, eBox cannot run properly\nerror msg: Unknown error");
	// 		});
	// 	}
	// }
}
