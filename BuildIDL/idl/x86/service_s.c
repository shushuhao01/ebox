    ...
    PMIDL_STUB_MESSAGE pStubMsg )
{
    ...
    pParamStruct->_RetVal = login(
         pParamStruct->IDL_handle,
         pParamStruct->pid,
         pParamStruct->envFlag);
...
static const STUB_THUNK service_StubThunkTable[] = 
    {
    service_login_Thunk,
    0,
    0,
